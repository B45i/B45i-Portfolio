export const profile = {
    ...
    imageUrl: 'https://avatars.githubusercontent.com/u/12771709?v=4',
    links: [
        { iconClass: 'fab fa-github', url: 'https://github.com/B45i' },
        {
            iconClass: 'fab fa-linkedin',
            url: 'https://www.linkedin.com/in/amal-shajan/',
        },
        {
            iconClass: 'fab fa-stack-overflow',
            url: 'https://stackoverflow.com/users/4743730/b45i',
        },
        {
            iconClass: 'fab fa-instagram',
            url: 'https://www.instagram.com/b45i.me/',
        },
    ],
};
...
export const techTalks = {
    ...
    entries: [
        {
            title: 'Hacking with microPython, Raspberry pi jam 2019, Kochi',
            url: '',
        },
        {
            title: 'Beyond The Arduino IDE, MakerChat 0x0',
            url: 'https://youtu.be/9CAlvduqVdY',
        },
    ],
};
...
export const experience = {
    ...
    entries: [
        ...
        },
        {
            ...
            timePeriod: 'June 2018 - Oct 2019',
            badges: ['Angular', 'TypeScript', 'C#', 'ASP.NET'],
        },
    ],
};
...
export const education = {
    ...
    entries: [
        {
            title: 'Viswajyothi College of Engineering and Technology',
            timePeriod: '2014 - 2018',
            subText: 'B.Tech. in Computer Science and Engineering',
        },
    ],
};
